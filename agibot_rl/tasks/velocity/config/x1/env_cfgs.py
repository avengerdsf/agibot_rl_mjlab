...
def agibot_x1_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  ...
  cfg.metrics["fixed_upper_body_actuator_force_ratio"] = MetricsTermCfg(
    func=mdp.actuator_force_ratio,
    params={
      "sensor_names": [
        "robot/jointeffort_left_shoulder_yaw",
        "robot/jointeffort_right_shoulder_yaw",
        "robot/jointeffort_left_elbow_yaw",
        "robot/jointeffort_right_elbow_yaw",
        "robot/jointeffort_left_wrist_pitch",
        "robot/jointeffort_right_wrist_pitch",
        "robot/jointeffort_left_wrist_roll",
        "robot/jointeffort_right_wrist_roll",
      ],
      "effort_limits": [35.0] * 8,
      "log_prefix": "Metrics/fixed_upper_body_actuator_force_ratio",
      "log_per_sensor": True,
    },
  )
